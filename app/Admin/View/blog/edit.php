<?php
$this->title('Editar Post '.$rs['id']);
?>
<script src="/vendor/tinymce/js/tinymce/tinymce.min.js"></script>
<script src="/vendor/tinymce/js/tinymce/langs/pt_BR.js"></script>
<div id="divMenuTop" style="height: 75px;">
    <div id="menuTop" class="panel panel-body"><span style="display: inline-block;padding-top:5px;font-size: 18px;margin: 0;line-height: 1;"><?= $rs['titulo'] ?> </span>
        <div class="pull-right col-md-2" style="padding-left: 1px"><button class="btn btn-primary btn-block" onclick="submitForm();" >Salvar</button></div>
        <div class="pull-right col-md-2" style="padding-right: 1px"><a href="<?= '/blog/' . $rs['c_slug'] . '/' . $rs['slug'] ?>" target="_blank" class="btn btn-default btn-block">Visualizar</a></div>
    </div>
</div>
<div class="row">
    <div class="col-md-8">
