        <form id="imageUploadForm" method="POST" action="/admin/blog/post/img"  enctype="multipart/form-data" >
            <?php if(!empty($rs['img'])){ ?>
            <img  class="img-post thumbnail" style="margin-bottom: 4px!important;margin: auto;width: 100%;" src="<?= $rs['img'] ?>" />
            <?php }else{ ?>
            <img  class="img-post  thumbnail" style="margin-bottom: 4px!important;margin: auto;width: 100%;" src="/img/sem-imagem.jpg" />
            <?php } ?>
            <span class="btnEnviarImg btn btn-block btn-file ink-reaction btn-raised btn-primary">
                ...
                <span class="img-normal">
                    ...
                    <input type="hidden" name="id_post" value="<?= $rs['id'] ?>">  
                </span>
            </span>
        </form>
        <!-- Modal -->
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div>
                            <img id="image" style="max-width: 550px;" src="" alt="Imagem Enviada">
                        </div>
                    </div>
...
<?php
$this->cropper();
$this->addJs('/assets/js/upload-img-blog.js');
